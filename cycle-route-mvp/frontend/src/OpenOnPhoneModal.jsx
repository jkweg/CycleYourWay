    ...
    <div className="fixed inset-0 z-[2000] flex items-center justify-center bg-stone-900/40 p-4 backdrop-blur-sm">
      ...
      >
        <div className="mb-4 flex items-start justify-between gap-4">
          <div>
            <h2 id="open-on-phone-title" className="text-xl font-semibold text-burnt-orange">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="rounded-2xl border border-burnt-orange/20 bg-white p-4 shadow-sm">
            <QRCodeSVG value={rideUrl} size={196} level="M" marginSize={1} />
          </div>

          {routeName && (
            <p className="text-center text-sm font-medium text-burnt-orange">{routeName}</p>
          )}

          <div className="w-full rounded-lg bg-vanilla-deep px-3 py-2">
          ...
          <button
            type="button"
            onClick={handleCopy}
            className="soft-button w-full rounded-xl bg-burnt-orange px-4 py-2.5 text-sm font-semibold text-vanilla transition hover:bg-burnt-orange-dark"
          >
